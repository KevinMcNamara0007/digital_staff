        ...
        <div>
            ...
            {showMatrix && <div>
                <img className="img-fluid mb3 p-1" alt="matrix"
                     src={`${baselink}/Data/data_matrix?key=${keys[2]}&source=${keys[1]}&training_set=${JSON.stringify(data)}`}
                />
            </div>}
            {showBalancer && <div>
                <img className="img-fluid mb3 p-1" alt="matrix"
                     src={`${baselink}/Data/data_balancer?key=${keys[2]}&source=${keys[1]}&training_set=${JSON.stringify(data)}`}
                />
            </div>}
        </div>
    )
