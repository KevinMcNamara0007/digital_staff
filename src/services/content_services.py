...
async def final_draft_service(original, style, persona, review, model):
    prompt = ("INSTRUCTIONS:"
              f"1. You are an expert {style} writer."
              f"2. You will peer review the feedback and improve the original based on {review}."
              f"3. Respond with only the final draft of the original after adjusting it based on the review."
